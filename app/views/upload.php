                        ...
                        <div class="row">
                            <div class="col">
                                <div class="p-5">
                                    ...
                                    <form class="user" action="<?= BASE_URL?>/Dokumen/upload_dokumen" method="POST" enctype="multipart/form-data">
                                        <div class="row">
                                            <div class="col-6">
                                                <!-- NIM -->
                                                <div class="form-group">
                                                    <input type="text" class="form-control"
                                                        id="nim" aria-describedby="emailHelp" name="nim"
                                        ...
                                        <div class="form-group">
                                            <input type="text" class="form-control"
                                                id="judul" aria-describedby="emailHelp" name="judul"
                                        ...
                                        <div class="form-group">
                                            <select name="pembimbing" class="form-control" id="pembimbing">
                                                <option selected disabled value="">-- Masukkan Dosen Pembimbing Anda --</option>
                                            </select>
